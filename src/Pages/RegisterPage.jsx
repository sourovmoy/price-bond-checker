        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-90px)] px-4">
          <div className="w-full max-w-md p-8 border border-gray-100 rounded-2xl shadow-xl bg-white text-center space-y-5 animate-fadeIn">
            ...
            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
              আমরা আপনার ইমেইলে একটি ভেরিফিকেশন লিঙ্ক পাঠিয়েছি। মেইলটি ওপেন করে
              লিঙ্কে ক্লিক করলেই এই পেজটি অটোমেটিক রিফ্রেশ হয়ে অ্যাপে নিয়ে
              যাবে—নতুন করে লগইন করার প্রয়োজন নেই। ( ইমেইলটি না পেলে অনুগ্রহ করে
              আপনার Spam ফোল্ডারটি চেক করুন।)
            </p>
